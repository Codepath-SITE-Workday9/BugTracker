...
import TeamsGif from "../../Gifs/TeamGif.gif"
import ProjectsGif from "../../Gifs/ProjectsGif.gif"
import StatisticsGif from "../../Gifs/StatisticsGif.gif"
...
export function ContentNavigation()
{
  ...
  const sectionContent = [{value:"teams",name: "Work More Easily With Everyone", description: "Tracker Max provides you with all the necessary tools to collaborate with any team no matter how big or how small. Get quick information of all your collaborators!", point1: "Collaborate with multiple teams or individually", point2: "Assign teams to all your projects", point3:"Assign tickets to anyone who is on your team", gif: TeamsGif},
                          {value:"projects",name: "Create Projects For All Your Big Ideas", description: "Tracker Max simple design allows anyone and everyone to create a project with other teams or individually and begin bug tracking quickly. Get all your project information on a single page!", point1: "Streamline work by collaborating with other teams", point2: "Complete creative control over your projects", point3:"View all your tickets for your projects from one page", gif: ProjectsGif},
                          {value:"tickets",name: "Report Bugs In Seconds", description: "Tracker Max simple issue ticketing system allows you to log bugs instantaneously and collaborate with your teams to resolve them. Get a complete picture of everything you need to know about your issues from the moment you log in!", point1: "Learn about tickets with the click of a button", point2: "Get overviews about your most complex tickets", point3:"Look at visual displays of your ticket statistics", gif: TicketsGif},
                          {value:"statistics", name: "Optimize Your Performance", description: "Tracker Max provides you with all the statistics necessary to learn how quickly you solve tickets and the complexity of your projects over time. Get real time statistics with the click of a button!", point1: "Get Project Complexity Statistics Real Quick", point2: "Get Real Time Ticket Information", point3:"Look at visual charts to learn about your performance", gif: StatisticsGif}]
      ...
      <div className="content-nav">
          ...
          <div className="content-nav-sections">
              ...
              <div className="content-section-img">
                  <img src={content.gif} id="content-section-gifs"></img>
              </div>
          </div>
      </div>
    )
